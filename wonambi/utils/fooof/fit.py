...
from .utils import trim_spectrum
from .plts.fm import plot_fm
from .core.io import save_fm, load_json
from .core.reports import save_report_fm
from .core.funcs import gaussian_function, get_bg_func, infer_bg_func
from .core.utils import group_three, check_array_dim
from .core.modutils import get_obj_desc, copy_doc_func_to_method
from .core.strings import gen_settings_str, gen_results_str_fm, gen_issue_str, gen_wid_warn_str

from .synth import gen_freqs, gen_background, gen_peaks
